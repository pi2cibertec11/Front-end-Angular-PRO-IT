        ...
        <nav class='navbar navbar-default'>
            <div class='container-fluid'>
                ...
                <ul class='nav navbar-nav'>
                    ...
                    <li><a     [routerLink]="['/productsreg']">Registrar Platillos</a></li>
...
export class AppComponent {
 ...
 clients:IClient;
  ...
  constructor(private _clienteService:ClientService,public cdRef:ChangeDetectorRef){
 ...
 // }
  ...
  existeUsuario():boolean{
      if(this.clients!=null){return true;}
else{return false;}
  }
